...
\cite{mertens} (equation \ref{eqn:mertensestimate}), however, this is very
...
(eq.  \ref{eqn:sestimate}), where $f(i)$ is the same function for stock factors from
equations \ref{eqn:myestimate}, ${128 \choose i}$ is top estimate
