...
Algorithm walks througt all the possible moves, performs evaluation
of subsequent positions and picks up the action bringing the most advantageous
position.  Evaluation is done by static evaluation funciton or the same
...
will be certainly left off from choosing.
